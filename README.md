...
**Linux:**
```bash
wget https://github.com/coltwillcox/hackerminal/releases/latest/download/hackerminal-1.1.0-linux-amd64.tar.gz
tar -xzf hackerminal-1.1.0-linux-amd64.tar.gz
cd hackerminal-1.1.0-linux-amd64
./hackerminal
```

**macOS:**
```bash
curl -LO https://github.com/coltwillcox/hackerminal/releases/latest/download/hackerminal-1.1.0-darwin-arm64.tar.gz
tar -xzf hackerminal-1.1.0-darwin-arm64.tar.gz
cd hackerminal-1.1.0-darwin-arm64
./hackerminal
```
